<?php
/**
 * Title: About Intro - Media Right
 * Slug: tktk/about-intro-reverse
 * Description: About section with portrait on right, text content on left, with background image support
 * Categories: sections
 * Keywords: about, portrait, introduction, background, reverse
 * Viewport Width: 1200
 */
?>
